...
// CARDS / BOOKINGS
// Verified live on 2026-07-02 against 3 real WC2026 fixtures: API-Football's
// /odds feed carries ZERO cards/bookings markets across all 33 bookmakers
// checked, even though "Cards Over/Under" exists as a bet-type ID in the
// catalog. Corners and other markets ARE present; cards is not. This is a
// source limitation, not a bug in the matcher (WANTED_STAKE_MARKETS) or the
// extractor (extractStakeMarkets) — both are correct and intentionally left
// in place for the day a feed populates cards.
